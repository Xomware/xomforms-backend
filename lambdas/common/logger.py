...
lambdas/common/logger.py (see docs/features/xomforms/PLAN.md).
...
class XomformsLogger:
    ...
    def __init__(self, log_level: str = "INFO"):
        ...
        if XomformsLogger._initialized and XomformsLogger._logger:
            self.logger = XomformsLogger._logger
            return

        self.log_level = log_level.upper()

        self.logger = logging.getLogger("xomforms")
        ...
        XomformsLogger._logger = self.logger
        XomformsLogger._initialized = True
...
LOGGER = XomformsLogger(LOG_LEVEL)
